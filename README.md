...
with `ksana_`, current date and time in the name and `.ksr` ("ksana recording")
extension.
...
Reads the specified file (generated by dumper) and prints the basic information
about it in the standard output.
